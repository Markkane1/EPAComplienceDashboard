...
import Notification from "../../../infrastructure/db/mongoose/models/Notification.js";
import { authRequired } from "../middlewares/auth.js";
import { mapNotification } from "../../../infrastructure/db/mongoose/mappers/mappers.js";
...
router.get("/", authRequired, async (req, res) => {
  ...
  const items = await Notification.find(query).lean().sort({ created_at: -1 }).limit(pageLimit);
