...
import { applicationUseCases, documentUseCases } from "@/ui/app/container";
...
const ApplicationDetails = () => {
  ...
  const adjournMutation = useMutation({
    mutationFn: async () => {
      ...
      return applicationUseCases.adjourn(String(id), payload);
    },
    onSuccess: () => {
  ...
  const approveMutation = useMutation({
    mutationFn: async () => {
      ...
      return applicationUseCases.approve(String(id), payload);
    },
    onSuccess: () => {
  ...
  const rejectMutation = useMutation({
    mutationFn: async () => {
      ...
      return applicationUseCases.reject(String(id), payload);
    },
    onSuccess: () => {
