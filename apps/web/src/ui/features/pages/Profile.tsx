...
const Profile = () => {
  ...
  const updateProfileMutation = useMutation({
    mutationFn: async () => {
      ...
      return authUseCases.updateProfile({
  ...
  const changePasswordMutation = useMutation({
    mutationFn: async () => {
      return authUseCases.changePassword({
  ...
  const uploadProfileImageMutation = useMutation({
    mutationFn: async () => {
      ...
      return authUseCases.uploadProfileImage(payload);
    },
    onSuccess: async () => {
  ...
  const removeProfileImageMutation = useMutation({
    mutationFn: async () => {
      return authUseCases.removeProfileImage();
    },
    onSuccess: async () => {
